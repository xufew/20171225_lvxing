...
def predict(modelSavePath, extraTree, naProducer):
    ...
    predictValue = extraTree.predict(rfModel, testX)
...
if __name__ == '__main__':
    ...
    modelPath = Config.MODEL_EXTRATREE
    ...
    extraTree = few_model.ExtraTree(param)
    # extraTree.cv(trainX, trainY)
    # extraTree.line_search(trainX, trainY)
    extraTree.train(trainX, trainY, modelPath)
    predict(modelPath, extraTree, naProducer)
