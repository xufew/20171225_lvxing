...
def predict(modelSavePath, adaboost, naProducer):
    ...
    predictValue = adaboost.predict(rfModel, testX)
...
if __name__ == '__main__':
    ...
    modelPath = Config.MODEL_ADABOOST
    ...
    adaboost = few_model.AdaBoost(param)
    # adaboost.cv(trainX, trainY)
    adaboost.line_search(trainX, trainY)
    # adaboost.train(trainX, trainY, modelPath)
    # predict(modelPath, adaboost, naProducer)
